...
public class ProfileSetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageImage = FirebaseStorage.getInstance().getReference().child("Profile Pictures");
        mAuth = FirebaseAuth.getInstance();
        mProgress = new ProgressDialog(this);

        mProfileImageBtn = (ImageButton) findViewById(R.id.profileImageBtn);
    ...
    private void startSetupAccount() {
        ...
        if(!TextUtils.isEmpty(name) && mImageUri != null){
            mProgress.setMessage("Finishing your profile ...");
            mProgress.show();
            ...
            filepath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mDatabaseUsers.child(user_id).child("Display Name").setValue(name);
                    mDatabaseUsers.child(user_id).child("Profile Picture").setValue(downloadUri);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mProfileImageBtn.setImageURI(mImageUri);
